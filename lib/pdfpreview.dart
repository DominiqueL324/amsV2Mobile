...
class _PdfViewerPageState extends State<PdfViewerPage> {
    ...
    pdf.addPage(pw.MultiPage(
        ...
        footer: (pw.Context context) {
          ...
          edl['signataires'].forEach((key, value) {
            if (value["paraphe"] != null) {
              paraphe =
                  paraphe + value["paraphe"].toString().toUpperCase() + ", ";
            }
          });
          return pw.Container(
            ...
            child: pw.Text(
                'AMS Software, version 2  Page: ${pages.toString()}    ${paraphe}',
                style:
          ...
          edl['signataires'].forEach((key, value) {
            ...
            if (value != null) {
              ...
              signataires.add(pw.TableRow(children: [
                ...
                pw.Text(
                  "tel: ${value['telephone'] == null ? '' : value['telephone']}\nemail: ${value['email'] == null ? '' : value['email']}\nReference: ${ref}",
                  style: pw.TextStyle(fontSize: 12),
                ),
              ]));
                          ...
                          pw.TableRow(children: [
                            pw.Table(children: [
                              ...
                              pw.TableRow(children: [
                                ...
                                pw.Text('N° étage: '),
                                pw.Text(
                                  edl['logement']['nbre_etage'] == null
                                      ? "xxxx"
                                      : edl['logement']['nbre_etage'],
                                  style: pw.TextStyle(
                                      fontSize: 10,
                                      fontWeight: pw.FontWeight.bold),
                                )
                              ...
                              pw.TableRow(children: [
                                ...
                                pw.Text(
                                  edl['logement']['Code_fact'] == null
                                      ? 'xxxx'
                                      : edl['logement']['Code_fact'],
                                  style: pw.TextStyle(
                                      fontSize: 10,
                                      fontWeight: pw.FontWeight.bold),
                                ),
                                ...
                                pw.Text('N° porte: '),
                                pw.Text(
                                  edl['logement']['Num_porte'] == null
                                      ? 'xxxx'
                                      : edl['logement']['Num_porte'],
                                  style: pw.TextStyle(
                                      fontSize: 10,
                                      fontWeight: pw.FontWeight.bold),
                                )
                              ...
                              pw.TableRow(children: [
                                ...
                                pw.Text('Parking: '),
                                pw.Text(
                                  edl['logement']['parking'] == null
                                      ? 'xxxx'
                                      : edl['logement']['parking'],
                                  style: pw.TextStyle(
                                      fontSize: 10,
                                      fontWeight: pw.FontWeight.bold),
                                ),
                ...
                pw.Row(children: [
                  pw.Table(
                    children: [
                      ...
                      pw.TableRow(
                        children: [
                          pw.Text('EDL N°: ', style: pw.TextStyle(fontSize: 8)),
                        ],
                      ),
                    ],
                  ),
                  ...
                  pw.Table(
                    children: [
                      ...
                      pw.TableRow(
                        children: [
                          pw.Text(
                              'En présence de: ${edl['created_by']['prenom'].toString().toUpperCase()} ${edl['created_by']['nom'].toString().toUpperCase()}',
                              style: pw.TextStyle(fontSize: 8),
                              textAlign: pw.TextAlign.right),
                        ],
                      ),
              ...
              children: [
                pw.Column(
                    ...
                    children: [
                      pw.SizedBox(
                          child: pw.Text(
                        "${e['role'] == null ? 'Bailleur'.toUpperCase() : e['role'].toString().toUpperCase()}",
                        textAlign: pw.TextAlign.left,
                        style: pw.TextStyle(
                          fontSize: 12,
                          fontWeight: pw.FontWeight.bold,
                      ...
                      pw.SizedBox(
                          width: 150,
                          child: pw.Text(
                              "${e['nom'].toString().split(
                                    "   ",
                                  )[0]}  ${e['prenom'] == null ? '' : e['prenom'].toString()}",
                              textAlign: pw.TextAlign.left,
                              style: const pw.TextStyle(
                                fontSize: 12,
                              ),
  ...
  /*Future<void> downloadPDF(pdfUrl, String pdfName) async {
  ...
  ShowDialogwaiter(BuildContext context,
      {int echec = 0,
      String texte =
          "Opération terminée avec succees!!! Votre constat a été sauvegarder vous pouvez le retrouver dans la plateforme web les données de ce constat seront définitivement supprimer de votre mobile dans 15 jours!!!"}) {
  ...
  void showSnackBar(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Text('Opération en cours.......'),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          Visibility(
            ...
            child: ElevatedButton.icon(
              onPressed: () async {
                ...
                Future res = etatRealisationProvider.validateEdl(
                    globals.getString("edlId"), pdfPath);
                res.then((value) {
                  this.signatureVisibility = false;
                  hideSnackBar(context);
                  if (value == true) {
                    ShowDialogwaiter(context);
                  } else {
                    ShowDialogwaiter(context,
                        echec: 1,
                        texte:
                            "Echec de la sauvegarde du constat verifiez vitre connexion internet et reessayez");
                  }
                });
              },
              label: Text(""),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          if (pdfPath != null) {
            //downloadPDF(pdfPath, edl['_id'].toString());
            final directory = await getApplicationDocumentsDirectory();
            String nom = edl['_id'].toString() + ".pdf";
            final image = File('${directory.path}/$nom');
            // Download the PDF file
            final file = File(pdfPath);
            // Replace `destinationPath` with the desired path to save the downloaded PDF
            final destinationPath = image.path;
            file.copy(destinationPath);
            SnackBar(
              content: Text('Téléchargement Ok vers' + image.path.toString()),
            );
            // Show a snackbar or display a message to indicate successful download
          }
        },
      ),
    );
