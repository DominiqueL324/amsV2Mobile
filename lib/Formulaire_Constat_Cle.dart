...
class _Formulaire_Constat_CleState extends State<Formulaire_Constat_Cle> {
  ...
  Widget build(BuildContext context) {
    ...
    res.then((value) {
      ...
      Future type_edl = etatRealisationProvider
          .checkTypeEdl(globals.getString("edlId").toString());
      type_edl.then((value) {
        if (value == "sortant") {
          remise_rendue = true;
        } else {
    ...
    return Scaffold(
        ...
        body: ListView(
          children: [
            ...
            Visibility(
              visible: !remise_rendue,
              child: Conteneur_formulaire(
                  maxLines: 10,
