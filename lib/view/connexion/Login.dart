...
class _LoginState extends State<Login> {
  ...
  void seConnecter() async {
    if (usernameController.text.isNotEmpty &&
      ...
      dynamic authData = await _authenticationController.login(
      ...
      if (authData['refreshToken'] != null && authData['accessToken'] != null) {
        ...
        prefs.setString('nomUser', authData['user']['user']['nom']);
        prefs.setString('prenomUser', authData['user']['user']['prenom']);
        prefs.setString('emailUser', authData['user']['user']['email']);
        //print(authData);
